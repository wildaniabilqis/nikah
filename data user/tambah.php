...
<head>
    ...
    <style>
        ...
        * {
        ...
        body {
            /* Background gradien linear ungu-biru lembut sama seperti dashboard utama */
        ...
        .login-container {
            background: #ffffff;
            width: 100%;
            max-width: 500px; /* Ukuran pas untuk form input */
            padding: 40px;
            border-radius: 20px;
    ...
    <div class="login-container">
        ...
        <form method="post">
            ...
            <div class="button-group">
                ...
                <button type="submit" name="update" class="btn btn-tambah">Simpan User</button>
            </div>
        </form>
    </div>
</body>
