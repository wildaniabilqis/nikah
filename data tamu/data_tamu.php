...
<head>
    ...
    <style>
        * {
        ...
        /* Gaya ketika menu aktif atau disorot mouse */
        ...
        .main-content {
            margin-top: 70px; /* Sesuai dengan tinggi navbar atas */
            flex-grow: 1;
            padding: 40px;
            display: flex;
        ...
        /* --- Container Utama Putih Padat Elegan --- */
        .container {
            background: #ffffff;
            width: 100%;
            max-width: 1100px;
        ...
        /* Mengunci Tombol Aksi Bersandingan Ke Samping */
        .action-group {
            display: flex;
            gap: 8px; /* Jarak pas antar tombol */
            align-items: center;
        }
        ...
        .action-link {
            ...
            font-size: 13px;
            font-weight: 600;
            padding: 8px 16px; /* Proporsi kapsul tombol lebih mantap */
            border-radius: 6px;
...
<body>
    ...
    <!-- Mengubah class sidebar menjadi navbar atas -->
    <div class="navbar">
        <div class="brand">UNDANGAN DIGITAL</div>
        
        <menu>
            <a href="../data user/data_user.php">Data Pengguna</a>
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        <?php
                            $data = mysqli_query($conn, "SELECT * from data_tamu ORDER BY nama ASC");
                            $no = 1; 
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($item['kehadiran']); ?></td>
                            <td><?= htmlspecialchars($item['jumlah']); ?> Orang</td>
                            <td><?= htmlspecialchars($item['pesan']); ?></td>
                            <td>
                                <div class="action-group">
                                    <a href="edit.php?id=<?= $item['id']; ?>" class="action-link link-edit">Edit</a>
                                    <a href="hapus.php?id=<?= $item['id']; ?>" class="action-link link-delete" onclick="return confirm('Apakah anda yakin ingin menghapus data tamu ini?')">Delete</a>
                                </div>
                            </td>
                        </tr> 
                        <?php
