...
<head>
    ...
    <style>
        ...
        * {
        ...
        body {
            /* Background gradien linear serasi dengan seluruh ekosistem dashboard */
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <select name="kehadiran" required>
                    <option value="Hadir" <?= ($item['kehadiran'] == 'Hadir') ? 'selected' : ''; ?>>Hadir</option>
                    <option value="Insyaallah hadir" <?= ($item['kehadiran'] == 'Insyaallah hadir') ? 'selected' : ''; ?>>Insyaallah hadir</option>
                    <option value="Tidak hadir" <?= ($item['kehadiran'] == 'Tidak hadir') ? 'selected' : ''; ?>>Tidak hadir</option>
                </select>
            </div>

            <div class="form-group">
                <label>Jumlah Pendamping</label>
                <input type="number" name="jumlah" min="1" value="<?= htmlspecialchars($item['jumlah']); ?>" required>
            </div>

            <div class="form-group">
                <label>Ucapan & Do'a</label>
                <input type="text" name="pesan" value="<?= htmlspecialchars($item['pesan']); ?>" required>
            </div>
